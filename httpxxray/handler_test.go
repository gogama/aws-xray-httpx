...
func TestHandler_Handle(t *testing.T) {
	...
	t.Run("full flow", func(t *testing.T) {
		t.Run("serial[one attempt]", func(t *testing.T) {
			...
			assert.Same(t, executionSeg, attemptSeg.ParentSegment)
			assert.Equal(t, executionSeg.ID, attemptSeg.ParentID)
		...
		t.Run("racing[multiple attempts]", func(t *testing.T) {
			...
			assert.Same(t, executionSeg, attempt0Seg.ParentSegment)
			assert.Equal(t, executionSeg.ID, attempt0Seg.ParentID)
			...
			assert.Same(t, executionSeg, attempt1Seg.ParentSegment)
			assert.Equal(t, executionSeg.ID, attempt1Seg.ParentID)
